...
# Set today's total number of homework tasks
total_homework = 4
original_count = total_homework
print(f"You have {original_count} homework tasks to finish today!\n")
 
# Keep a counter for completed homework and the current task number
completed_count = 0
task_num = 1
 
# Repeat while there are still homework tasks left
while task_num <= total_homework:
 
    # Work out the current homework task from its number
    if task_num == 1:
    ...
    # Only move on once the task is marked done
    if answer == "yes":
        completed_count += 1
        task_num += 1
    ...
    # Print how many homework tasks remain
    print("Homework tasks remaining:", total_homework - completed_count)
    print()
 
# This only prints once every homework task is marked done
print("===== ALL HOMEWORK COMPLETE! =====")
print("Great work finishing your homework today!\n")
 
# A safe look at what an infinite loop would look like
...
# Print the final homework checklist summary
