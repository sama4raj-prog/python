...
# Use * operator to repeat a sample marks list
sample_marks = [10, 20, 30] * 2
print("Repeated Sample Marks:", sample_marks)
 
# Find the length of the marks list
...
# Reverse the marks list using slicing
reversed_marks = marks[::-1]
print("Reversed Marks:", reversed_marks)
 
# Function to find marks that start and end with same digit
...
# Iterate through the list to find sum and average
total = 0
...
# Sort the list to find smallest and largest marks
marks.sort()
 
print("Smallest mark is:", marks[0])
print("Largest mark is:", marks[-1])
 
# Print the final student marks summary
print("")
